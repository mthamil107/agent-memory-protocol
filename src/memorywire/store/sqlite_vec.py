...
This adapter is the default local backend for the memorywire reference
implementation. It implements every operation in the
:class:`memorywire.store.MemoryStore` Protocol on top of a single SQLite database
...
class SqliteVecStore:
    ...
    def _parse_fsm(content: str) -> dict[str, Any]:
        ...
        in :class:`memorywire.models.ProcedureSpec`. Non-object payloads still get a
    ...
    def _merge_sync(self, req: MergeRequest) -> MergeResponse:
        ...
        the canonical and duplicate strings may be either memorywire memory ids or
