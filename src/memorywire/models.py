...
# All memorywire models share the same pydantic config: forward-compat extras, alias
...
class RememberRequest(BaseModel):
    ...
    Mirrors :file:`src/memorywire/schemas/operations/remember.json`.
    """
...
class RecallRequest(BaseModel):
    ...
    Mirrors :file:`src/memorywire/schemas/operations/recall.json`.
    """
...
class ForgetRequest(BaseModel):
    ...
    Mirrors :file:`src/memorywire/schemas/operations/forget.json`.
...
class MergeRequest(BaseModel):
    ...
    Mirrors :file:`src/memorywire/schemas/operations/merge.json`.
    """
...
class ExpireRequest(BaseModel):
    ...
    Mirrors :file:`src/memorywire/schemas/operations/expire.json`.
    """
...
class RememberResponse(BaseModel):
    ...
    Mirrors :file:`src/memorywire/schemas/operations/remember.response.json`.
    """
...
class RecallResponse(BaseModel):
    ...
    Mirrors :file:`src/memorywire/schemas/operations/recall.response.json`.
    """
...
class ForgetStoreResult(BaseModel):
    ...
    :file:`src/memorywire/schemas/operations/forget.response.json`.
    """
...
# Memory *facade* class to ``memorywire.__init__``; this name is the wire-format
...
class ProcedureSpec(BaseModel):
    ...
    Mirrors the ``content`` object of :file:`src/memorywire/schemas/types/procedural.json`.
    """
